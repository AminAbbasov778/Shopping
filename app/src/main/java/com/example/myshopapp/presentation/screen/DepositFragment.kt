...
import com.example.myshopapp.databinding.FragmentDepositBinding
import com.example.myshopapp.presentation.util.collectEvents
import com.example.myshopapp.presentation.viewmodel.DepositViewModel
    ...
    private fun observeState() {
        ...
        viewLifecycleOwner.lifecycleScope.launch {
            viewModel.state.collect { s ->
                ...
                binding.btnDeposit.isEnabled   = !s.isLoading
            }
        }
    }
}